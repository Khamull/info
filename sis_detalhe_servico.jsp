...
<%
//Pesquisa informaç&#337;es sobre o Serviço
...
<tr>
 ...
 <table width="696" align="center" cellpadding="2" cellspacing="2">
  ...
  <tr bgcolor="#F9F6F2">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
    <a href="javascript: confirma(<%=rs.getString("servicoID")%>)" title="Clique aqui para confirmar a visualizaçao">[ confirmar visualiza&ccedil;&atilde;o ]</a></td>
  </tr>
  <tr bgcolor="#FFFF99">
